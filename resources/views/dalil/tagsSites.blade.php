                ...
                <div class="main-nav" style="width: 12rem">
                    <div class="btn-group">
                        ...
                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown"
                            ...
                            <img src="{{ url('../public/uploading/' . $country_namess->country->country_flag) }}" alt="" style="margin-left:5px">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list">
                                @foreach ($country_names as $get_country)
                                    <li id="eee">
                                        <img src="{{ url('../public/uploading/' . $get_country->country_flag) }}" alt="" style="margin-left:5px">
        ...
        @isset($tagss)
                    ...
                    <div class="box-main-sub">
                        <div class="border-sub-h">
                            <h6>المواقع التي تحتوي على نفس الوسم:</h6>
                        </div>
                        <ul>
                            @foreach ($tagss as $eel)
                                @foreach ($eel->sites as $index => $rr)
                                    ...
                                    <li>
                                        ...
                                        <span><a class="text-decoration-none cc" href="{{$rr->href}}"><i class='fas fa-globe' style="font-size: 15px"></i></a></span>
                                        <a class="anchor" href="{{route('get_descr' , [$rr->title,$rr->id])}}">{{ $rr->site_name }}</a>
                                    </li>
                                    @endif
                                @endforeach
                            @endforeach
