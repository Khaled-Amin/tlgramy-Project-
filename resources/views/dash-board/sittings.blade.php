...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ url('../public/dashboard/css/sittingsStyle.css') }}" rel="stylesheet" />
                            ...
                            <ul class="dropdown-menu  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="url(../public/assets/img/team-2.jpg)" class="avatar avatar-sm  ms-3 ">
                                            </div>
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="url(../public/assets/img/small-logos/logo-spotify.svg)"
            ...
            <div class="row backgroundW p-4  ">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" class="@error('nameWebsite') is-invalid @enderror form-controll "
                        ...
                        value="@isset($DataSittings) {{ $DataSittings->nameWebsite }} @endisset"
                        required>
                </div>
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" class="form-controll" name="linkWebsite" id="inputLastNmae"
                        value="@isset($DataSittings) {{ $DataSittings->linkWebsite }} @endisset">
                </div>
                ...
                <div class="col-md-6 mb-3 ">
                    ...
                    <input type="text" class="form-controll " name="socialMidiaFacebook" id="inputlink1"
                        value="@isset($DataSittings) {{ $DataSittings->socialMidiaFacebook }} @endisset">
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-controll" name="socialMidiaTelegram" id="inputlink2"
                        value="@isset($DataSittings) {{ $DataSittings->socialMidiaTelegram }} @endisset">
                </div>
                <div class="col-12 mb-3">
                    ...
                    <input type="text" class="form-controll" name="socialMidiaInstagram" id="inputlink3"
                        value="@isset($DataSittings) {{ $DataSittings->socialMidiaInstagram }} @endisset">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-controll" name="socialMidiaYoutube" id="inputlink4"
                        value="@isset($DataSittings) {{ $DataSittings->socialMidiaYoutube }} @endisset">
                </div>
