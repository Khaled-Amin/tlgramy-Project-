            ...
            <form action="{{ route('sites.store') }}" method="POST">
                ...
                <div class="form-row mb-2">
                    <div class="col">
                        ...
                        <input type="text" class="form-controll" name="site_name" placeholder="اسم الموقع">
                    </div>
                    {{-- <div class="col">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="ckeditor form-controll" name="description" placeholder="وصف"></textarea>
                    </div>
                </div>
