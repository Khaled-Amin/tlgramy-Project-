            ...
            <form action="{{ route('categories.update' , $category->id) }}" method="POST">
                ...
                <select style="width: 200px" class="form-cdontrol" id="category" name="category">
                    ...
                    @foreach ($categories as $item)
                        <option value="{{$item->id }}" {{$category->id == $item->id  ? 'selected' : ''}}>{{ $item->category_name }}</option>
                    @endforeach
                </select>
                ...
                <select style="width:200px;" class="form-cdontroll" name="subcategory" id="subcategory">
                    ...
                    @foreach ($scategory as $ff)
                        <option value="{{$ff->id}}" {{$category->id == $ff->id  ? 'selected' : ''}}>{{ $ff->category_name }}</option>
                    @endforeach
                </select>

                <div class="form-group">
                    <label for="exampleFormControlInput1">اسم التصنيف</label>
                    <input type="text" class="form-controll" name="category_name"  value="{{$category->category_name}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="visible_status" value="1" {{($category->visible_status ==1?'checked' : '')}}>
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            category) {
                                ...
                                $('#category').append('<option value="' + category[0]
                                    .id + '">' + category[0].category_name + '</option>');
                            })
                            console.log(data);
                        }
                    })
