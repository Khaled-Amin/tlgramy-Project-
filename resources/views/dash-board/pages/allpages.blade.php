        ...
        <div class="row backgroundW p-4 m-3">
            ...
            <div class="container">
                <div class="form-group btn-create">
                    <h4>الصفحات</h4>
                    <a href="{{ route('pages.create') }}" class="btn btn-success">اضافة الصفحات</a>
                </div>
            </div>
                        ...
                        @foreach ($showallpages as $item)
                            <tr>
                                ...
                                <div class="row">
                                    ...
                                    <td>{{ $item->href }}</td>
                                    <td>{{ Str::limit($item->page_content, 20) }}</td>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href="{{ route('pages.edit', $item->id) }}"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                        </div>

                                        <div class="col-sm">
                                            <a href="{{ route('pages.destroy', ['id' => $item->id]) }}"><i
