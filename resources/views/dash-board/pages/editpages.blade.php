...
<head>
    ...
    <link rel="stylesheet" href="{{ aurl('../public/css/asw.css') }}">
</head>
        ...
        <div class="row backgroundW p-4 m-3">
            ...
            <form action="{{ route('pages.update' , $page->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-controll" name="page_name"  value="{{$page->page_name}}">
                </div>

                <div class="form-group">
                    <label for="exampleFormControlInput1">رابط الصفحة</label>
                    <input type="text" class="form-controll" name="href"  value="{{$page->href}}">
                </div>

                <div class="form-group">
                    <label for="exampleFormControlInput1">محتوى الصفحة</label>
                    <input type="text" class="form-controll" name="page_content"  value="{{$page->page_content}}">
                </div>
